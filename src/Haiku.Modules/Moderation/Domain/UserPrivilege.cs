...
/// each privilege corresponds to a single action category defined in <see cref="PrivilegeNames"/>
...
public class UserPrivilege
{
    ...
    /// </summary>
    /// <value>One of the values defined in <see cref="PrivilegeNames"/> (e.g., <c>moderate_poems</c>, <c>manage_dictionary</c>).</value>
    [Required]
    [MaxLength(50)]
