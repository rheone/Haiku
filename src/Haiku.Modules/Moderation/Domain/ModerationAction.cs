...
namespace Haiku.Modules.Moderation.Domain;
...
/// constants defined in <see cref="ModerationActionTypes"/> and <see cref="TargetTypes"/>.
...
public class ModerationAction
{
    ...
    /// </summary>
    /// <value>One of <see cref="ModerationActionTypes"/>: Hide, Unhide, Disable, or Reinstate.</value>
    [Required]
    [MaxLength(50)]
    ...
    /// </summary>
    /// <value>One of <see cref="TargetTypes"/>: Poem, User, DictionaryWord, or DictionarySuggestion.</value>
    [Required]
    [MaxLength(20)]
