...
public class SyllableFibClassifierTests
{
    ...
    [Fact]
    /// <summary>Verifies the classifier identifies a valid Fibonacci syllable pattern (1, 1, 2, 3, 5).</summary>
    ...
    [Fact]
    /// <summary>Verifies the classifier rejects non-Fibonacci counts.</summary>
    ...
    [Fact]
    /// <summary>Verifies the classifier priority is 1800.</summary>
    public void Priority_Is1800_Test()
    {
